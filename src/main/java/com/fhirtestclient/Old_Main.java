...
import com.fhirtestclient.helper.UserUpdate;
...
public class Old_Main {
    ...
    public static void main(String[] args) {
        ...
        multiMessage(1000, messages5, null);
    ...
    private static void multiMessage(int waitMilliSecondsBetweenRequests, String[] messages, User u) {
        ...
        for(int i = 0; i < messages.length; i++) {
            if (messages[i].equals("registerECGDevice")) {
                ...
                singleMessage(messages[i], deviceInfo + ":" + dataProvider.getIliData(1), null);
            } else {
